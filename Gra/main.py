...
class Game:
    def __init__(self):
        ...
        match difficulty:
            case 0: self.difficulty_level = DifficultyLevel.m4
            case 1: self.difficulty_level = DifficultyLevel.ak
            case 2: self.difficulty_level = DifficultyLevel.pistol
            case 3: self.difficulty_level = DifficultyLevel.shotgun
